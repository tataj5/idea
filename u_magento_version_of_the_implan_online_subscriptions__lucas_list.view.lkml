view: u_magento_version_of_the_implan_online_subscriptions__lucas_list {
  sql_table_name: implan.u_magento_version_of_the_implan_online_subscriptions__lucas_list ;;
