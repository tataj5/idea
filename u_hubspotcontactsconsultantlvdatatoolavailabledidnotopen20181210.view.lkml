view: u_hubspotcontactsconsultantlvdatatoolavailabledidnotopen20181210 {
  sql_table_name: implan.u_hubspotcontactsconsultantlvdatatoolavailabledidnotopen20181210 ;;
  ...
  dimension: first_contact_create_date {
    type: string
    sql: ${TABLE}.first_contact_create_date ;;
  }
